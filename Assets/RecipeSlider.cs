...
public class RecipeSlider : MonoBehaviour
{
    ...
    private void CheckPos()
    {
        if (yPos <= -185.3)
        {
            ...
            this.gameObject.transform.localPosition = new Vector3(236.7f, -185.3f, 0);
            //CCrb.velocity = Vector2.zero;
            crafting.transform.localPosition = new Vector3(585f, 0, 0);
            this.gameObject.GetComponent<SpriteRenderer>().flipX = true;
        }

        if (yPos >= 184.8f)
        {
            this.gameObject.transform.localPosition = new Vector3(236.7f, 184.8f, 0);
            // CCrb.velocity = Vector2.zero;
            crafting.transform.localPosition = new Vector3(585f, 933.7f, 0);
